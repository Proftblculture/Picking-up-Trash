...
public class MainCharacter {
	...
	private static final int RIGHT_RUN = 0;
	...
	public MainCharacter() {
		...
		normalRunAnim.addFrame(Resource.getResouceImage("data/Man-1.png"));
		normalRunAnim.addFrame(Resource.getResouceImage("data/Man-2.png"));
		jumping = Resource.getResouceImage("data/Man-3.png");
		downRunAnim = new Animation(90);
		downRunAnim.addFrame(Resource.getResouceImage("data/Man-5.png"));
		downRunAnim.addFrame(Resource.getResouceImage("data/Man-6.png"));
		deathImage = Resource.getResouceImage("data/Man-4.png");
